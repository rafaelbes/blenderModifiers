...
class Skin4Springs(bpy.types.Operator):
    ...
    def execute(self,context):
        ...
        if fechar_face == True:
            ...
            bm.faces.new((lista_para_faces[i-2], lista_para_faces[1], lista_para_faces[3], lista_para_faces[i]))
            bm.faces.new((lista_para_faces[i-3], lista_para_faces[0], lista_para_faces[2], lista_para_faces[i-1]))
            bm.faces.new((lista_para_faces[i-3], lista_para_faces[0], lista_para_faces[1], lista_para_faces[i-2]))
            bm.faces.new((lista_para_faces[2], lista_para_faces[i-1], lista_para_faces[i], lista_para_faces[3]))
